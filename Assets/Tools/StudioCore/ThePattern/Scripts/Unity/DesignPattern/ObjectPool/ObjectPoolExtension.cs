...
namespace ThePattern.Unity
{
    public static class ObjectPoolExtensions
    {
        ...
        public static bool IsSpawned<T>(this T prefab) where T : Component
        {
            return ObjectPool.IsSpawned(prefab.gameObject);
        }

        public static bool IsSpawned(this GameObject prefab)
        {
            return ObjectPool.IsSpawned(prefab);
        }
