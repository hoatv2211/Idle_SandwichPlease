...
public class HRRoomUnit : UnitBase
{
    [Header("BUILDING")]
    [Tooltip("Unlock")]
    ...
    public override void Action_UnlockUnit()
    {
        ...
        if(IdUnit== "upgrade_office")
            UIMainGame.Instance.btnUpgradePlayer.gameObject.SetActive(true);

        if (IdUnit == "hr_office")
            UIMainGame.Instance.labelUpgrade.SetActive(true);
    }
